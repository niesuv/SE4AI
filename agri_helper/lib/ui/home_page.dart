  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        padding: const EdgeInsets.only(top: 70, left: 10, right: 10, bottom: 32), // Tăng bottom padding cho chắc
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            Container(
              // Đặt maxHeight, KHÔNG đặt height cứng!
              constraints: BoxConstraints(
                maxHeight: size.height * 0.65, // Hoặc 0.6 nếu vẫn overflow
              ),
              ...
              child: Column(
                ...
                children: [
                  // ... giữ nguyên phần Row location, avatar, icon search ...
                  // ... phần Image thời tiết, nhiệt độ, trạng thái ...
                  // ... phần WeatherItem (gió, độ ẩm, mây) ...
                  Row(
            ...
            Container(
              // KHÔNG đặt height, cứ để tự nhiên hoặc set maxHeight nhỏ thôi
              child: Column(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
      ...
      // Nếu có BottomNavigationBar thì đặt ngoài này như bình thường
    );
  }
}
